...
According to Noruzi (2004) and Anderson (2019), the emergence of modern FLFX papers began with a resurgence of interest in Ranganthan during the 1992 centenary of his birth, which happily coincided with the mass adoption of online services.<sup>1</sup> (Just a few years prior, Sethi (1986) described R.'s work as gradually sliding into "obsolescence" due to a variety of factors, including the "vicious influence of Western propaganda.") Three decades hence, the FLFX trope has become so established that many papers include a near-identical paragraph listing the various & sundry fields to which its applied. Hold my hand as we stare together into the ouroborosian gyre:
