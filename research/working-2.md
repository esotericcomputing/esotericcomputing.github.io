...
_The Five Laws of Library Science_'s continuining impact is evidenced by a robust and growing corpus which, cribbing a tech-industry term, I will call "Five Laws For X" \[FLFX\]. 
The emergence of modern FLFX papers began with a resurgence of interest in Ranganthan during the 1992 centenary of his birth, which happily coincided with the mass adoption of online services. (Noruzi, 2004; Anderson, 2019).<sup>1</sup> (Just a few years prior to this resurgance, Sethi (1986) described R.'s work as gradually sliding into "obsolescence" due to a variety of mainly-external factors, including the "viscious influence of Western propaganda.") Three decades hence, the FLFX trope has become so established that many papers include near-identical paragraphs listing the various & sundry fields to which the framework has been applied. Hold my hand as we stare together into the ouroborosian gyre of academia:
...
FLFX papers generally fall between two poles, with the majority clustering more toward the former:
...
- **Lazy Papers:**
  ...
  - Focus on outcomes (or idealized scenarios) of their reworded laws, without significant detail on the practical, systemic, or organizational changes required to arrive thereat.

- **Robust Papers:**
  - Include discussion of the full work, including R.'s specific interpretation of of the laws' meaningins and implications.
  - Include paralells between R.'s analysis of his library system's social, political, and legal context in the analysis and discussion of the paper's updated laws.
  - Exhibit freedom in rewording R.'s laws to more accurately align with the meaning the paper is forwarding.

In a sense, R.'s success in distilling the wording of his Laws into their most general, abstract, and punchy forms is a double-edged sword. On the one hand, they ignite the immagination and inspire us to service; But on the other, divorced from his book's exegesis, a reader risks the pitfall of -- for example -- immagining the Declaration of Independence's second sentence was meant to be understood literally by its authors. The devil's in the details. We'll examine a few Robust papers a little later; But presently, we'll see what we can learn from the specific modes of laziness we encounter.
...
Table 1 shows the words that "book" and "reader" are replaced with in papers which noun-swap the Five Laws. While "book" enjoys a boquet of translations, the "reader" in each has mostly become a "user." (Alas, McNeil's _[Lurking: How a Person Became A User](https://www.nytimes.com/2020/02/25/books/review/joanne-mcneil-lurking.html)_ lies unread in my TBR stack, so I'll have to spitball.)

Part of this is likely concision and convenience; "Use" is a short word, and a linguistic superset that obviates the need to precisely define all the different actions one could take when (e.g.) using a website with multiple functions. This is, of course, lazy. Engaging with the definition process has the potential to tease out a user's motivations, and group or subdivide users to add meaningful nuance and context to the arguments the new laws are trying to make.

But there's also something a little unsettling about seeing this wooly manegerie of information sources, media, and institutions undergo a sort of flattening; a decontextualization of their significant differences to acamodate ingestion by a uniform user. If "Books are for use!", the "use" they are "for" is "reading", as specified in 2nd and 3rd laws. Noun-swaped laws generally fail to make this clarification as they proceed sequentially.
...
1. **Libraries Serve Humanity**: Both in the personal and universal sense, i.e., "the furtherance of the higher aspirations of humankind." "The psychological urge to serve is at the root of successful careers in librarianship and its psychic rewards are many." (p. 748)"
...
4. **Protect Free Access to Knowledge**: Gorman here means "soul" and "aetheric" content; that is, freedom of inquiry: "A society without uncensored libraries is a society open to tyanny." An interesting lacuna exists here regarding the practical acquisition of material; e.g., what is the "protect\[ive\]" responsibility of a librarian when the library cannot afford the material which a patron should have "free access" to to?

5. **Honor the Past and Create the Future**: Once again seemingly writing around library's headlong rush in the digital age, Gorman advocates for decision-making rooted in "a sense of history and a knowledge of enduring values and the continuity of our mission".

While _The Five Laws_ is broadly forward-looking, R. traces the history of libraries from antiquity to the rapid growth of international (mainly European) systems of his day. He saw, in his time and place, the opportunity to lay the philosophical, political, and legislative groundwork for a thriving library system in his home country. Gorman, decades later, advocates for retaining this praxis of historical situation when envisioning library futures.
...
Frankly, I have many analytical criticisms of this work -- foremost among them, George's reading of the Five Laws is reductive and IMO somewhat incorrect<sup>2</sup> -- but I appreciate that they thoroughly recharacterized the Five Laws from the ground-up for "Generation Z":

1. **Put Content First, Not the Container.** Information now arrives in multiple formats; ergo the mode of search and discovery should focus on the information content (e.g. the book's "soul" and "aetheric content" in R.'s esoteric framework). This is a practical suggestion, but George's statements about the universal availability of digitized content and the lack of user preference about the work's "gross body" (ibid) are flat wrong.
...
4. **Information Quantitative Analysis.** "A quantifiable evaluation is crucial in the digital age since Generation Z tends to think all the time logically." \[Citation Needed\] Basically, George is advocating for data-driven analysis and decision-making strategies.

5. **The Common Learning (Online and Offline).** In considering what element of the library system is currently "growing," George recommends leaning into the freeform spaces libraries provide for collaborative user interaction.

Additionally, George's take on the Fourth Law (Save the time of the reader) clarifies something that's been bothering me. Consider the following: “But this guideline makes it very clear: We have a responsibility to respect the time of our users since it is valuable.” (George, 2022) In _The Five Laws_, R. invokes the bromide "Time is Money"; to which O'Dell rightly asks, "Whose Time? Whose Money?" This "Fungible Time" framework assumes a library's end-goal is the minimization or elimination of temporal interface between the "user" and "information." \[Author Note: I'll expand on this (and likely relocate it) during final revisions.\]
...
Anderson, et al.'s \[hereafter, A.\] introduction opens with a clear problem statement: The high cost of textbooks is creating a barrier between students and learning. "With costs often exceeding $1,000 per year, it is not surprising that many students choose to simply forgo purchasing them." Throughout the paper (particularly in the "Law #2" section), they cite additional studies exploring the extent of the problem, and discuss the broader systemic framework exacerbating the problem:
...
In seeking sollutions, A. focus primarily (though not exclusively!) on Open Educational Resources \[OER\], a broad shorthand for free-of-cost materials for use in class settings. While the rewritten Laws use a noun-swap (Books->Educational Resources, Reader->Student), their accompanying discussions are wide-ranging, and follow Ranganathan's method of identifying and rectifying systemic barriers to the Laws' enactment.



### 1. Educational Resources are for Use

The first law sets the ideological table by discussing the origin of the term "OER" from UNESCO's 2002 Forumn on the Impact of Open Coursework for Higher Education, and the 2007 Cape Town Open Education Declaration (supported by signatories like MIT, SPARC, Carnegie Mellon, etc.) to conclude that "access to information is a basic human right."

Rather than shying away from the First Law's implication that money is a barrier to "use," A. gamely discuss higher education budget cuts, alternative stratgies of corporate sponsorship or full privitization; And cite studies showing that "textbook publishers are particularly adept at exploiting the lack of choice in the supposedly capitalistic market surrounding education" and the burdens of textbook access fall heaviest on students already facing economic pressure. "Therefore, open education attempts to make education accesible to all by removing cost barriers for course materials."



### 2. Every Student their Educational Resource

True to R.'s structural focus of the second law, A. state "academic libraries must first identify who their community is and determine whether or not library collections and collection development policies truly meet community needs."

After a hefty chunk of summarized research on the cost of textbooks, A. examine policies related to Library acquision of textbook and course materials (which in some cases "historically... prohibit their purchase with library funds or their request via interlibrary loan"), and efforts "in recent years" to implement "course reserves programs":
...
Opening with a spot-on take of R's third law, which "focuses on the intersection of discoverability, equitable access, and the variety of information formats," A. discuss later interpretations (as mentioned earlier in this FLFX summary) regarding the provision of various & sundry digital formats, to "meet users where they are."

The opening paragraph includes a lengthy discussion of R.'s push for open stacks library designs, which connects to the second paragraph discussion of ideal digital-format qualities to support OER. Proprietary formats (Flash, Blackboard, etc.) pose barriers not only to content access, but also content _revision_. A. suggests the adoption of the CARE framework \[Contribute, Attribute, Release, and Empower (Petrides, Levin, & Watson, 2018)] when surveying OER content for a university. Once again, the Library's role here broadens and dovetails with that of the Unviersity at large, and the instructors in particular, as our information system expertise positions us to effectively "steward" a university's OER content, and participatory revisions required thereof.
...
In 1931, R. argued that open stacks saves everyone's time; We're now in the "exact opposite" circumstance, "where an overabundance of OER can be overwhelming and difficult for faculty members to navigate." The time-suck of not only locating but reviewing OER material may lead an instructor to stick with an expensive commercial textbook for sheer expediency. And already strapped for time, when no OER is available for specialized classes, an instructor may balk at the time required to create that content.
...
To facilitate discoverability of EOR, A. suggest libraries are well-situated to produce faculty-facing guides, run workshops, and increase awareness of EOR via their existing email newsletters. They suggest libraries could get involved with "OER organizations like OpenStax and Merlot," which facilitate OER discovery and review. And finally,
...
Here, we find A. happily picking up R.'s advocacy torch, reminding Librarians to be unaffraid of speaking up and telling it like it is.



### 5. OER Are Growing Organisms

After discussing R.'s perspectives on growth and the central "organism" metaphor, A. discuss the implications of OER's primarily-digital character in the growth of its adoption in universities.

On one hand, many instructors and students fine digital formats "unattractively nebulous;" but on the other, "Unlike other digital resources, libraries do not need to negotiate or pay for OER subscriptions." But with acquisition comes the need for retention; and careful library forethought must be excersized to ensure stable OER access and capacity for expansion.
...
Finally, the "open" in OER means that academic libraries have the opportunity to coordinate for a divide-and-conquery strategy. Different universities have different educational focuses, ergo their librarians have strong domain expertise therein. U.C. Davis could specialize in assessing and creating agricultural OER; MIT in software; University of Iowa in poetry; and Reed in interdisciplinary artwork. This collectivist working strategy is absolutely of a piece with R.'s broad perspectives on the universal responsibility of a society to provide free educational resources to its people.
